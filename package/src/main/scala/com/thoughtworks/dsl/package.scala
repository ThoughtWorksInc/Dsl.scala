...
/** This project, '''Dsl.scala''', is a framework to create embedded '''D'''omain-'''S'''pecific '''L'''anguages.
  ...
  * and [[https://github.com/ThoughtWorksInc/each ThoughtWorks FromIterable]].
  *
  * = Introduction =
  *
  ...
  * [[https://github.com/ThoughtWorksInc/each ThoughtWorks FromIterable]], [[http://monadless.io/ Monadless]]
  * and [[https://github.com/pelotom/effectful effectful]] are macros
  * that convert ordinary control flow to monadic control flow.
  *
  * For example, with the help of [[https://github.com/ThoughtWorksInc/each ThoughtWorks FromIterable]],
  ...
  * FromIterable of the above DSLs can be only exclusively enabled in a code block.
  * For example,
  * [[https://github.com/scala/scala-continuations scala-continuations]]
  ...
  *          instead of monads.
  *
  *          We provide a [[com.thoughtworks.dsl.keywords.FromIterable FromIterable]]
  ...
  *          import com.thoughtworks.dsl.keywords.FromIterable
  *          import com.thoughtworks.dsl.domains.scalaz._
  *          import scalaz.std.stream._
  *
  ...
  *                  !Stream.empty[Int]
  *                case children =>
  *                  val child: File = !FromIterable(children)
  *                  !countEach(child)
  *              }
  *            } else {
  *              scala.io.Source.fromFile(file).getLines.size
  ...
  *          Dsl.scala allows non-monadic keywords like [[com.thoughtworks.dsl.keywords.FromIterable FromIterable]] works along with
  *          monads.
